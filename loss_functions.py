...
#         """
#         y_pred: logits (batch_size, num_classes)   # raw outputs from model
#         y_true: class indices (batch_size,)        # true class labels (not one-hot)
#         """
...
y_pred = torch.tensor([[2.0,1.0,0.1,-1.2],
                       [0.5,2.3, -0.5,0.0],
                       [1.2, -0.3,2.1, 0.8]], requires_grad=True)
